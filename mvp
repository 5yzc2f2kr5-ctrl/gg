...
def get_decision(character: str, options: list[dict], narrator_role: str) -> dict:
    """Return structured decision data. `options` is a list of 2-4 dicts:
...
def decision_selected(character: str, letter: str) -> dict:
    ...
    `letter` is the chosen option (A-F). Use this to resume the narrative
